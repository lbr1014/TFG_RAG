...
\tightlist
	...
	\item Documento: esta entidad representa un pdf cargado en la aplicación. Maneja un identificador (id) como clave primaria, el nombre del fichero, el tamaño, la fecha de modificación, el número de \textit{chunks} en la base de datos vectorial y el estado del documento (cargado, procesado, indexado, fallido). 
