...
Para el \textit{web scraping} se ha valorado usar \href{https://beautiful-soup-4.readthedocs.io/en/latest/}{Beautiful Soup}, \href{https://selenium-python.readthedocs.io/}{Selenium}, \href{https://playwright.dev/}{Playwright} y \href{https://requests.readthedocs.io/en/latest/}{Requests}. Finalmente se ha elegido usar Playwright. Requests solo gestiona HTTP sin ejecutar JavaScript, Beautiful Soup es un parse de HTML/XML para extraer y navegar por el DOM descargado. Pero cuando la web es dinámica Selenium y Playwright son mejores opciones ya que hay que automatizar un navegador. Pese a que selenium controla navegadores reales y es un estándar veterano Playwright es más completo. Ya que ofrece automatización multi-navegador con contextos aislados, funcionamiento headless, espera automática de elementos y APIs consistentes, lo que lo vuelve más robusto y rápido para páginas con JS pesado y flujos de login.