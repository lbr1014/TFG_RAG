...
\tightlist
	...
	\item CU-15 Crear usuarios
	\item CU-16 Borrar usuarios
	\item CU-17 Modificar rol del usuario
	\item CU-18 Editar usuario
\end{itemize}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-12, RF-12.1, RF-12.2 \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-1.2, RNF-4 \\
		\textbf{Descripción}          & Permite al administrador ver el estado de los documentos cargados en el sistema (cargado, procesado, indexado o fallido). \\
		\textbf{Precondición}         & Hay un administrador autentificado y existe al menos un documento cargado en el sistema. \\
		\textbf{Acciones}             &
		\begin{enumerate}
			\def\labelenumi{\arabic{enumi}.}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-15}    & \textbf{ Crear usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-16}    & \textbf{ Borrar usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-17}    & \textbf{ Modificar rol del usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-17 Modificar rol del usuarios.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-17}    & \textbf{ Editar usuario}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
