...
\tightlist
	...
	\item CU-12 Consultar estado de los documentos
	\item CU-13 Eliminar documento
	\item CU-14 Crear usuarios
	\item CU-15 Borrar usuarios
	\item CU-16 Modificar rol del usuario
	\item CU-17 Editar usuario
\end{itemize}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-14}    & \textbf{ Crear usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-15}    & \textbf{ Borrar usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-16}    & \textbf{ Modificar rol del usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-16 Modificar rol del usuarios.}
\end{table}
