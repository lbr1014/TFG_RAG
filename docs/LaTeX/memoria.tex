...
{\thesubsection.}     % <- muestra el número seguido de punto
...
El proyecto integra un \eng{pipeline} completo de recuperación semántica capaz de automatizar la obtención de documentos mediante técnicas de \eng{Web Scraping}, convertir los documentos PDF extraídos a formato Markdown, fragmentar el contenido en \eng{chunks}, generar \eng{embeddings} y almacenarlos en una base de datos vectorial Qdrant. A partir de las consultas realizadas por el usuario, el sistema recupera los fragmentos documentales más relevantes y los incorpora al contexto del modelo generativo para mejorar la precisión, actualidad y fiabilidad de las respuestas. Esto permite analizar la relevancia, fidelidad y precisión de las respuestas generadas mediante la combinación de los \eng{frameworks} RAGAS y ARES con métricas de \eng{embeddings}.

Además del diseño e implementación del sistema RAG, el proyecto desarrolla una aplicación \eng{web} utilizando Flask, incorporando autenticación de usuarios, historial de consultas, gestión documental, internacionalización, visualización de estadísticas y soporte \eng{responsive}. Esta aplicación \eng{web} ha sido desplegada utilizando Docker, Gunicorn y Nginx. 
