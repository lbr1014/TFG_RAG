...
Los objetivos del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/2?closed=1}{Sprint 2} fueron seguir investigando sobre los LLM y RAG y explicar la información relevante en los conceptos teóricos. Investigar sobre el \eng{Web Scraping} y explicar en los anexos el plan de proyecto, en concreto la planificación temporal y los \eng{sprints}.
Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
...
Los objetivos del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/3?closed=1}{Sprint 3} fueron realizar un primer prototipo de \eng{Web Scraping}, tanto en Selenium como en Playwright. Incluir en la memoria las correcciones y la información relevante.
Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
	\item Añadir las correcciones a la memoria.
...
Los objetivos del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/4?closed=1}{Sprint 4} fueron continuar realizando la aplicación de \eng{Web Scraping}, tanto en Selenium como en Playwright, para sacar licitaciones de la página de \contsec{}. Incluir en la memoria una comparación entre ambas aplicaciones de \eng{Web Scraping}. Seguir investigando sobre los RAG.
Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
...
Los objetivos del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/5?closed=1}{Sprint 5} fueron investigar sobre las mejoras que aporta la API asíncrona de Playwright y como se implementa. También, se planificado investigar sobre la gestión de dependencias y entornos en Python. Todo esto mientras se sigue investigando sobre los RAG y LLM y se escriben los aspectos más relevantes en la memoria. 
Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
	\item Realizar código con Playwright asíncrono.
	\begin{itemize}
	\tightlist
		\item Investigar sobre la API asíncrona de Playwright.
	\end{itemize}
	\item Investigar sobre las dependencias y los entornos en Python.
	\item Escribir conceptos teóricos en la memoria.
	\begin{itemize}
	\tightlist
...
\tightlist
	...
	\item Investigar y probar modelos de inteligencia artificial de Hugging Face.
...
El objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/7?closed=1}{Sprint 7} fue investigar e implementar distintos tipos de \eng{tokenizer}. Esto se planteó como un primer paso para la implantación total del RAG.
Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
...
El objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/8?closed=1}{Sprint 8} fue implementar una base de datos para el RAG y juntarlo con uno de los \eng{tokenizers} ya implementados del \eng{sprint} anterior. Además, en este \eng{sprint} se planteó como objetivo obtener los pliegos definitivos de de la página de . 

Esto se debe a que los pliegos obtenidos anteriormente no eran correctos, se trataban de resúmenes incompletos que no servían para alimentar al RAG. Durante el \eng{sprint} 7, se encontraron los pliegos correctos y se fijo como objetivo del siguiente \eng{sprint} modificar los programa de \eng{Web Scraping} para descargarlos. 
Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
...
El objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/9?closed=1}{Sprint 9} fue realizar un \eng{script} que, dada una consulta, devuelva el \eng{chunk} más parecido. Junto con este \eng{chunk} debe devolver el nombre y el título del PDF, así como una respuesta del LLM basándose en dicho \eng{chunk}. Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
...
\tightlist
	...
	\end{itemize}
	\item Revisar y corregir código usando SonarCloud.
	\item Hacer que el LLM use más de un \eng{chunk} para responder.
\end{itemize}
...
El objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/15?closed=1}{Sprint 15} fue levantar mi aplicación Flask usando un contenedor Docker. En la reunión se decidió implementar un Docker ya que mejora la potabilidad, la ligereza y el aislamiento de la aplicación. Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
	\item Implementar un Docker para la aplicación Flask.
	\begin{itemize}
	\tightlist
		\item Estudiar como desplegar la aplicación \eng{web}.
		\item Arreglar la indexación de documentos para usar el Docker.
...
\tightlist
	...
	\tightlist
		...
		\begin{itemize}
		\tightlist
			\item Investigar como se pueden mandar correos automáticos desde Flask.
		\end{itemize}
	\end{itemize}
	\item Completar \eng{test} y generar el informe del \eng{coverage}.
	\item Incluir conversión a Markdown en la aplicación.
	\item Botón cancelar consulta.
\end{itemize}

Para realizar el \eng{sprint} se estimaron 24 horas de trabajo. Al finalizar el \eng{sprint} se realizaron todas las tareas invirtiendo unas 30 horas. Esto se debió a que la realización de los \eng{test} llevó más tiempo del planificado. Sobre todo, aquellos los de las clases concurrentes y aquellos para los que se necesitaba entorno con bases de datos.
...
\tightlist
	\item Documentar la carpeta prototipos.
		\begin{itemize}
		\tightlist
			\item Documentar en GitHub la aplicación {Flask} con Docker.
			\item Documentar los archivos de \eng{Web Scraping}.
			\item Documentar la carpeta \eng{tokenizer}.
			\item Documentar la carpeta Markdown.
			\item Documentar el directorio Flask
		\end{itemize}
		\item Explicar las herramientas para el Docker en la memoria.
\end{itemize} 
...
Como objetivos principales del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/20?closed=1}{Sprint 20} se fijaron realizar cambios en la interfaz gráfica de la \eng{web} y en el \eng{pipeline} de indexación del RAG. En la reunión se fijo que todos los elementos de la interfaz debían ser o utilizar elementos de Boostrap, para hacer que la interfaz sea completamente \eng{responsive}. Respecto al \eng{pipeline} de indexación del RAG se decidió introducir la conversión a Markdown. Para en un futuro \eng{sprint} hacer que los \eng{chunks} y \eng{embeddings} se obtengan desde los documentos Markdown y no los PDF. Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
...
\tightlist
	...
	\item Incluir la conversión a Markdown.
\end{itemize}
...
Como objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/21?closed=1}{Sprint 21} se fijó incluir en el \eng{pipeline} de indexación documental la conversión a Markdown del \eng{sprint} anterior. Además, de incluir correcciones en la memoria y seguir completando sus apartados. Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
...
\tightlist
	...
	\begin{itemize}
	\tightlist
		\item Corregir los fallos del Markdown.
	\end{itemize}
	\item Incluir correcciones en el código de los prototipos.
\end{itemize}

Para realizar el \eng{sprint} se estimaron 26 horas de trabajo. Al final se invirtieron más de 30 horas ya que corregir los fallos de la conversión a Markdown costó más de lo previsto. A pesar de que se ha mejorado el funcionamiento solventando problemas por \eng{timeout} o páginas no convertidas correctamente, aún presenta algún problema que se solventará en futuros \eng{sprints}. Por ejemplo, no captura bien los títulos y a veces se para en las conversiones largas.
...
Para realizar el \eng{sprint} se estimaron 40 horas de trabajo. Al finalizar el sprint se completaron todas las tareas más o menos en el plazo estimado. Como aspecto destacable cabe mencionar que a pesar de ejecutar la conversión a Markdown con la GPU sigue siendo muy lenta. Esto conlleva que todavía se paran las conversiones de los PDF más largos. Este problema se solucionará en \eng{sprints} posteriores.
...
Como objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/27?closed=1}{Sprint 27} se fijó cambiar algunos \eng{tempaltes} y CSS de la aplicación para introducir la última iteración del diseño de las interfaces. Estos cambios en el diseño tienen como objetivo tanto mejorar el aspecto de la \eng{web} como hacerla más accesible para los usuarios. Además, la conversión a Markdown sigue presentando algún problema, por ejemplo, cuando lleva mucho tiempo en ejecución satura la GPU haciendo que se tarde mucho en responder a las consultas. Respecto a la documentación se ha decidido seguir redactando algunos de los apartados que se empezaron a desarrollar en el \eng{sprint} anterior. Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
\begin{itemize}
\tightlist
...
\tightlist
	...
	\begin{itemize}
	\tightlist
		\item Estudiar el uso de driver.js.
	\end{itemize}
	...
	\end{itemize}
	\item Arreglos de los \eng{test} de integración.
...
La aplicación permite la gestión de usuarios mediante registro, autenticación e historial de consultas. Por ello, el sistema debe cumplir el Reglamento General de Protección de Datos (RGPD)~\cite{legal:procdatos} de la Unión Europea y la legislación española complementaria (LOPDGDD)~\cite{legal:procdatoses}. Concretamente el proyecto debe respetar el principio de minimización de datos, el almacenamiento seguro de contraseñas utilizando \eng{hash}, la confidencialidad de las consultas realizadas por los usuarios, la protección de las variables sensibles mediante ficheros de entorno, el uso de conexiones cifradas mediante HTTPS y certificados SSL/TLS.
...
La aplicación implementa diversas medidas destinadas a garantizar la seguridad del sistema y de la información almacenada, cumpliendo así con el Esquema Nacional de Seguridad (ENS)~\cite{legal:ENS}. Entre ellas destacan el uso de HTTPS, la autenticación de usuarios, la separación de secretos mediante variables de entorno, el despliegue mediante Docker, el aislamiento de servicios y el uso de certificados SSL/TLS.
